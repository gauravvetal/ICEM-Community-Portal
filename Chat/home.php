...
<html>
<head>
<title>Club Community Portal</title>
...
<table id="chat_room" align="center">
	<tr>
	<th><h4>Hi, <a href="profile.php?userid=<?php echo $_SESSION['userid']; ?>"><?php echo $urow['your_name']; ?></a></h4></th>
	</tr>
	<?php
	$id =$_GET['id'];
	...
	?>
				<div>
				<tr>
				<td>Welcome to <?php echo $row['chat_room_name']; ?></td><br><br>
				</tr>
				</div>
			<tr>
				<td>
